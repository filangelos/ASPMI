...
for i = 1:length(order)
    ...
    legend("show");
    saveas(fig, sprintf("Assignment2/assets/2.2/b/ar_%d.eps", order(i)), "epsc");
    hold off;
...
saveas(fig, "Assignment2/assets/2.2/b/error.eps", "epsc");
...
axis([xmin, xmax, ymin, ymax]);
saveas(fig, "Assignment2/assets/2.2/b/aic.eps", "epsc");